...
import static com.wpz.rbs.services.StaticHelpers.generateAuthForEndpoints;
...
public class TimetablesController {
    ...
    public String getRoomInfo(@PathVariable int id, int days, @RequestBody LoggedInAuthModel authModel) throws IOException {
        ...
        HttpRequestFactory requestFactory = new NetHttpTransport().createRequestFactory(generateAuthForEndpoints(authModel));
